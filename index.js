...
//
const BotName = 'BOT ./Tadaki-bot'; // Nama Bot Whatsapp
const instagramlu = 'nothing-'; // Nama Instagramlu cok
const whatsapplu = 'rahasia-'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@gamerz_wibu.edit`))
